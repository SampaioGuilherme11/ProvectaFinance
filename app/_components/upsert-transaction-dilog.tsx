...
interface UpsertTransactionDialogPros {
  isOpen: boolean;
...
const UpsertTransactionDialog = ({
  ...
  const onSubmit = async (data: FormSchema) => {
    try {
      ...
      await upsertTransaction({ ...dataWithAmountAsNumber, id: transactionId });
      setIsOpen(false);
      form.reset();
    } catch (error) {
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            <DialogFooter>
              ...
              <Button className="w-44 rounded-xl font-bold" type="submit">
